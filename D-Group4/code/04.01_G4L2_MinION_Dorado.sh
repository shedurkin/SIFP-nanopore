#!/bin/bash
## Job Name
#SBATCH --job-name=G4L2_MinION_Dorado
...
#SBATCH --chdir=/gscratch/srlab/kdurkin1/SIFP-nanopore/D-Group4/output/04.01-G4-Library2-MinION-Dorado-recall-GPU/
...
raw_pod5_dir=/gscratch/srlab/kdurkin1/SIFP-nanopore/D-Group4/data/04.01-G4-Library2-MinION-Dorado-recall-GPU/
output_dir=/gscratch/srlab/kdurkin1/SIFP-nanopore/D-Group4/output/04.01-G4-Library2-MinION-Dorado-recall-GPU/
...
--device ${GPU_devices} \
> ${output_dir}/FBD36396_pass_recalled.bam
