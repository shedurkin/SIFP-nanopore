03.01-G4-Library1-MinION-Dorado-recall-GPU
================
Kathleen Durkin
2025-10-29
...
```
    ...
    export output_dir_top=${nanopore_dir}/D-Group4/output/03.01-G4-Library1-MinION-Dorado-recall-GPU
    export data_dir_top=${nanopore_dir}/D-Group4/data/03.01-G4-Library1-MinION-Dorado-recall-GPU
    export raw_pod5_dir=${data_dir_top}/pod5_pass
    export raw_pod5_url1="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group4_MinION/Library1/20250905_1158_MD-101223_FBD08455_b87a1f92/pod5_pass/"
    export raw_pod5_url2="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group4_MinION/Library1_wash3/20250907_1505_MD-101223_FBD08455_50a8f15e/pod5_pass/"
...
<https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group4_MinION/Library1/20250905_1158_MD-101223_FBD08455_b87a1f92/pod5_pass/>
and
<https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group4_MinION/Library1_wash3/20250907_1505_MD-101223_FBD08455_50a8f15e/pod5_pass/>
...
after wash 3 (the run errored during wash 3)
...
```
    ...
    total 17K
    drwxr-sr-x 10 kdurkin1 nogroup  512 Oct 29 13:15 post_wash3
    drwxr-sr-x 28 kdurkin1 nogroup 8.0K Oct 29 13:14 pre_wash3
...
```
    ...
    3950904 0   total (QC-passed reads + QC-failed reads)
    1873490 0   primary
    1976324 0   secondary
    101090  0   supplementary
    0   0   duplicates
    0   0   primary duplicates
    2923804 0   mapped
    74.00%  N/A mapped %
    846390  0   primary mapped
    45.18%  N/A primary mapped %
...
primary reads (45.18%), which is ok. A large portion of reads
...
3950904-1976324-101090 = 1,873,490 reads). This is a rather annoying
...
```
    ...
    846390  0   total (QC-passed reads + QC-failed reads)
    846390  0   primary
    0   0   secondary
    0   0   supplementary
    0   0   duplicates
    ...
    0   0   with mate mapped to a different chr (mapQ>=5)
     ...
     443975 SQK-NBD114-96_barcode29
     191196 SQK-NBD114-96_barcode27
     158548 SQK-NBD114-96_barcode28
          1 SQK-NBD114-96_barcode90
          1 SQK-NBD114-96_barcode89
          1 SQK-NBD114-96_barcode82
          1 SQK-NBD114-96_barcode36
          1 SQK-NBD114-96_barcode33
          1 SQK-NBD114-96_barcode15
          1 SQK-NBD114-96_barcode11

There’s a discrepancy among the barcodes. The barcodes 27, 28, and 29
have ~0.2M, ~0.15M and ~0.45M reads, respectively.
...
filtering is base-level.

In mapped, primary-alignment reads, we observe low 6mA (~1%), low 5hmCG
(~4%), and moderately-low 5mCG (~6%). Notably, these are all higher than
in G1L4 (the modern samples)
...
![](03.01-G4-Library1-MinION-Dorado-recall-GPU_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
