---
title: "03-G4-Library1-MinION-Dorado-recall"
...
echo 'export output_dir_top=${nanopore_dir}/D-Group4/output/03-G4-Library1-MinION-Dorado-recall'
echo 'export data_dir_top=${nanopore_dir}/D-Group4/data/03-G4-Library1-MinION-Dorado-recall'
...
--no-parent \
--quiet \
--accept 'checksums.md5' ${raw_pod5_url2}
...
> ${output_dir_top}/FBD08455_pass_recalled.bam
...
# Alignment summary
$samtools flagstat FBD08455_pass_recalled.bam > alignment_summary.txt
head alignment_summary.txt

echo ""

# Summarize by barcode
$samtools view FBD08455_pass_recalled.bam | \
...
$samtools view -b -F 4 FBD08455_pass_recalled.bam > FBD08455_pass_recalled_mapped.bam

# Separate by barcode
samtools view -h FBD08455_pass_recalled_mapped.bam | awk '/^@/ || /BC:Z:SQK-NBD114-96_barcode27/' | samtools view -b > FBD08455_recalled_mapped_barcode27.bam
samtools view -h FBD08455_pass_recalled_mapped.bam | awk '/^@/ || /BC:Z:SQK-NBD114-96_barcode28/' | samtools view -b > FBD08455_recalled_mapped_barcode28.bam
samtools view -h FBD08455_pass_recalled_mapped.bam | awk '/^@/ || /BC:Z:SQK-NBD114-96_barcode29/' | samtools view -b > FBD08455_recalled_mapped_barcode29.bam
...
```{r, engine='bash', eval=TRUE}
source .bashvars
$samtools view -c ${output_dir_top}/FBD08455_pass_recalled.bam
$samtools view -c ${output_dir_top}/FBD08455_pass_recalled_mapped.bam

$modkit summary ${output_dir_top}/FBD08455_pass_recalled.bam
$modkit summary ${output_dir_top}/FBD08455_pass_recalled_mapped.bam
