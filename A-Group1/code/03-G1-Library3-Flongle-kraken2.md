03-G1-Library3-Flongle-kraken2
================
Kathleen Durkin
2025-09-29
...
echo 'export output_dir_top=${nanopore_dir}/A-Group1/output/03-G1-Library3-Flongle-kraken2'
echo 'export raw_fastqc_dir=${output_dir_top}/raw-fastqc'
echo 'export raw_reads_dir=${nanopore_dir}/A-Group1/data/03-G1-Library3-Flongle-kraken2/raw-reads'
echo 'export raw_reads_url="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group1_Flongle/Group1/Library3/20250815_1736_MD-101223_AYK267_a0699e0e/fastq_pass/"'

echo 'export trimmed_fastqc_dir=${output_dir_top}/trimmed-fastqc'
echo 'export trimmed_reads_dir=${nanopore_dir}/A-Group1/output/03-G1-Library3-Flongle-kraken2/trimmed-reads'
...
```
    ...
    export output_dir_top=${nanopore_dir}/A-Group1/output/03-G1-Library3-Flongle-kraken2
    export raw_fastqc_dir=${output_dir_top}/raw-fastqc
    export raw_reads_dir=${nanopore_dir}/A-Group1/data/03-G1-Library3-Flongle-kraken2/raw-reads
    export raw_reads_url="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group1_Flongle/Group1/Library3/20250815_1736_MD-101223_AYK267_a0699e0e/fastq_pass/"
    export trimmed_fastqc_dir=${output_dir_top}/trimmed-fastqc
    export trimmed_reads_dir=${nanopore_dir}/A-Group1/output/03-G1-Library3-Flongle-kraken2/trimmed-reads
...
<https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group1_Flongle/Group1/Library3/20250815_1736_MD-101223_AYK267_a0699e0e/fastq_pass/>
...
```
    ...
    total 72K
    drwxr-xr-x 2 shedurkin labmembers 20K Sep 29 15:52 barcode09
    drwxr-xr-x 2 shedurkin labmembers 16K Sep 29 15:52 barcode10
    drwxr-xr-x 2 shedurkin labmembers 16K Sep 29 15:52 barcode11
    drwxr-xr-x 2 shedurkin labmembers 20K Sep 29 15:52 unclassified
...
# ---- USER SETTINGS ----
input_dir <- "../output/03-G1-Library3-Flongle-kraken2/kraken2"   # change this
...
top_kingdom_barcode <- summary_by_barcode %>%
  filter(barcode %in% c("barcode09", "barcode10", "barcode11")) %>%
...
![](03-G1-Library3-Flongle-kraken2_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](03-G1-Library3-Flongle-kraken2_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->
