02-G1-Library2-Flongle-kraken2
================
Kathleen Durkin
2025-09-29
...
echo 'export output_dir_top=${nanopore_dir}/A-Group1/output/02-G1-Library2-Flongle-kraken2'
echo 'export raw_fastqc_dir=${output_dir_top}/raw-fastqc'
echo 'export raw_reads_dir=${nanopore_dir}/A-Group1/data/02-G1-Library2-Flongle-kraken2/raw-reads'
echo 'export raw_reads_url="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group1_Flongle/Group1/Library2/20250813_1334_MD-101223_AYW685_7f624b63/fastq_pass/"'

echo 'export trimmed_fastqc_dir=${output_dir_top}/trimmed-fastqc'
echo 'export trimmed_reads_dir=${nanopore_dir}/A-Group1/output/02-G1-Library2-Flongle-kraken2/trimmed-reads'
...
```
    ...
    export output_dir_top=${nanopore_dir}/A-Group1/output/02-G1-Library2-Flongle-kraken2
    export raw_fastqc_dir=${output_dir_top}/raw-fastqc
    export raw_reads_dir=${nanopore_dir}/A-Group1/data/02-G1-Library2-Flongle-kraken2/raw-reads
    export raw_reads_url="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group1_Flongle/Group1/Library2/20250813_1334_MD-101223_AYW685_7f624b63/fastq_pass/"
    export trimmed_fastqc_dir=${output_dir_top}/trimmed-fastqc
    export trimmed_reads_dir=${nanopore_dir}/A-Group1/output/02-G1-Library2-Flongle-kraken2/trimmed-reads
...
<https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group1_Flongle/Group1/Library2/20250813_1334_MD-101223_AYW685_7f624b63/fastq_pass/>
...
```
    ...
    total 108K
    drwxr-xr-x 2 shedurkin labmembers  16K Sep 29 15:38 barcode05
    drwxr-xr-x 2 shedurkin labmembers  20K Sep 29 15:38 barcode06
    drwxr-xr-x 2 shedurkin labmembers  16K Sep 29 15:38 barcode07
    drwxr-xr-x 2 shedurkin labmembers  20K Sep 29 15:38 barcode08
    drwxr-xr-x 2 shedurkin labmembers 4.0K Sep 29 15:38 barcode32
    drwxr-xr-x 2 shedurkin labmembers 4.0K Sep 29 15:38 barcode44
    drwxr-xr-x 2 shedurkin labmembers 4.0K Sep 29 15:38 barcode76
    drwxr-xr-x 2 shedurkin labmembers 4.0K Sep 29 15:38 barcode85
    drwxr-xr-x 2 shedurkin labmembers  20K Sep 29 15:38 unclassified
...
# ---- USER SETTINGS ----
input_dir <- "../output/02-G1-Library2-Flongle-kraken2/kraken2"   # change this
...
top_kingdom_barcode <- summary_by_barcode %>%
  filter(barcode %in% c("barcode05", "barcode06", "barcode07", "barcode08")) %>%
...
![](02-G1-Library2-Flongle-kraken2_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](02-G1-Library2-Flongle-kraken2_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->
