04-G1-Library4-Flongle-kraken2
================
Kathleen Durkin
2025-09-29
...
echo 'export output_dir_top=${nanopore_dir}/A-Group1/output/04-G1-Library4-Flongle-kraken2'
echo 'export raw_fastqc_dir=${output_dir_top}/raw-fastqc'
echo 'export raw_reads_dir=${nanopore_dir}/A-Group1/data/04-G1-Library4-Flongle-kraken2/raw-reads'
echo 'export raw_reads_url="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group1_Flongle/Group1/Library4/20250818_1549_MD-101223_AYL248_54e75371/fastq_pass/"'

echo 'export trimmed_fastqc_dir=${output_dir_top}/trimmed-fastqc'
echo 'export trimmed_reads_dir=${nanopore_dir}/A-Group1/output/04-G1-Library4-Flongle-kraken2/trimmed-reads'
...
```
    ...
    export output_dir_top=${nanopore_dir}/A-Group1/output/04-G1-Library4-Flongle-kraken2
    export raw_fastqc_dir=${output_dir_top}/raw-fastqc
    export raw_reads_dir=${nanopore_dir}/A-Group1/data/04-G1-Library4-Flongle-kraken2/raw-reads
    export raw_reads_url="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group1_Flongle/Group1/Library4/20250818_1549_MD-101223_AYL248_54e75371/fastq_pass/"
    export trimmed_fastqc_dir=${output_dir_top}/trimmed-fastqc
    export trimmed_reads_dir=${nanopore_dir}/A-Group1/output/04-G1-Library4-Flongle-kraken2/trimmed-reads
...
<https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group1_Flongle/Group1/Library4/20250818_1549_MD-101223_AYL248_54e75371/fastq_pass/>
...
```
    ...
    total 48K
    drwxr-xr-x 2 shedurkin labmembers 12K Sep 30 12:40 barcode12
    drwxr-xr-x 2 shedurkin labmembers 12K Sep 30 12:40 barcode13
    drwxr-xr-x 2 shedurkin labmembers 12K Sep 30 12:40 barcode14
    drwxr-xr-x 2 shedurkin labmembers 12K Sep 30 12:40 unclassified
...
# ---- USER SETTINGS ----
input_dir <- "../output/04-G1-Library4-Flongle-kraken2/kraken2"   # change this
...
top_kingdom_barcode <- summary_by_barcode %>%
  filter(barcode %in% c("barcode12", "barcode13", "barcode14")) %>%
...
![](04-G1-Library4-Flongle-kraken2_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](04-G1-Library4-Flongle-kraken2_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->
