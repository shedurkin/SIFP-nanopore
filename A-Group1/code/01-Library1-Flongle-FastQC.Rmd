---
title: "01-Library1-Flongle-FastQC"
...
echo 'export output_dir_top=${nanopore_dir}/A-Group1/output/01-Library1-Flongle-FastQC'
echo 'export raw_fastqc_dir=${output_dir_top}/raw-fastqc'
echo 'export raw_reads_dir=${nanopore_dir}/A-Group1/data/01-Library1-Flongle-FastQC/raw-reads'
...
echo 'export trimmed_reads_dir=${nanopore_dir}/A-Group1/data/01-Library1-Flongle-FastQC/trimmed-reads'
...
# Create array of raw FastQs (recursive to take subfolders into account)
raw_fastqs_array=($(find "${raw_reads_dir}" -type f -name "${fastq_pattern}"))
...
Getting long errors that seem to be related to Java graphics. Tried running in a conda environment, but got same error..
