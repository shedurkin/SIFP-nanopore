05.01-G2-Library3-MinION-Dorado-recall-GPU
================
Kathleen Durkin
2025-10-29
...
```
    ...
    export output_dir_top=${nanopore_dir}/B-Group2/output/05.01-G2-Library3-MinION-Dorado-recall-GPU
    export data_dir_top=${nanopore_dir}/B-Group2/data/05.01-G2-Library3-MinION-Dorado-recall-GPU
    export raw_pod5_dir=${data_dir_top}/pod5_pass
    export raw_pod5_url1="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group2_MinION/Group2_Library3_MK1B_sequencer/20250902_1444_MN47571_FBD42232_1580300f/pod5_pass/"
    export raw_pod5_url2="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group2_MinION/Group2_Library3_MK1B_after_wash2/20250903_2102_MN47571_FBD42232_3fa04fa7/pod5_pass/"
...
<https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group2_MinION/Group2_Library3_MK1B_sequencer/20250902_1444_MN47571_FBD42232_1580300f/pod5_pass/>
and
<https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group2_MinION/Group2_Library3_MK1B_after_wash2/20250903_2102_MN47571_FBD42232_3fa04fa7/pod5_pass/>
...
after wash 2 (run errored out during wash 2)
...
```
    ...
    total 17K
    drwxr-sr-x  6 kdurkin1 nogroup  512 Oct 30 02:10 post_wash2
    drwxr-sr-x 27 kdurkin1 nogroup 8.0K Oct 30 02:07 pre_wash2
...
```
    ...
    8176941 0   total (QC-passed reads + QC-failed reads)
    3396440 0   primary
    4554123 0   secondary
    226378  0   supplementary
    0   0   duplicates
    0   0   primary duplicates
    6807972 0   mapped
    83.26%  N/A mapped %
    2027471 0   primary mapped
    59.69%  N/A primary mapped %
...
primary reads (59.69%), which is good! The majority of reads confidently
...
8176941-4554123-226378 = 3,396,440 reads). This is a rather annoying
...
```
    ...
    cat: flagstat_summary_FBD42232_pass_recalled_mapped.tsv: No such file or directory

    bash: line 6: view: command not found

There’s a large discrepancy among the barcodes. The barcodes 24, 25, and
26 have ~0.3M, ~1M and ~0.7M reads, respectively.
...
low/negligible 6mA (~0.3%), low/negligible 5hmCG (~0.8%), and
...
![](05.01-G2-Library3-MinION-Dorado-recall-GPU_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
