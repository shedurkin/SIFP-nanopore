#!/bin/bash
## Job Name
#SBATCH --job-name=G2L2_MinION_Dorado
...
#SBATCH --chdir=/gscratch/srlab/kdurkin1/SIFP-nanopore/B-Group2/output/04.01-G2-Library2-MinION-Dorado-recall-GPU/
...
raw_pod5_dir=/gscratch/srlab/kdurkin1/SIFP-nanopore/B-Group2/data/04.01-G2-Library2-MinION-Dorado-recall-GPU/
output_dir=/gscratch/srlab/kdurkin1/SIFP-nanopore/B-Group2/output/04.01-G2-Library2-MinION-Dorado-recall-GPU/
...
--device ${GPU_devices} \
> ${output_dir}/FBD39370_pass_recalled.bam
