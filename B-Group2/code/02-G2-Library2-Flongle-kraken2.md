02-G2-Library2-Flongle-kraken2
================
Kathleen Durkin
2025-09-29
...
echo 'export output_dir_top=${nanopore_dir}/B-Group2/output/02-G2-Library2-Flongle-kraken2'
echo 'export raw_fastqc_dir=${output_dir_top}/raw-fastqc'
echo 'export raw_reads_dir=${nanopore_dir}/B-Group2/data/02-G2-Library2-Flongle-kraken2/raw-reads'
echo 'export raw_reads_url="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group2_Flongle/Library2/20250824_1851_MD-101223_AYX067_7881f908/fastq_pass/"'

echo 'export trimmed_fastqc_dir=${output_dir_top}/trimmed-fastqc'
echo 'export trimmed_reads_dir=${nanopore_dir}/B-Group2/output/02-G2-Library2-Flongle-kraken2/trimmed-reads'
...
```
    ...
    export output_dir_top=${nanopore_dir}/B-Group2/output/02-G2-Library2-Flongle-kraken2
    export raw_fastqc_dir=${output_dir_top}/raw-fastqc
    export raw_reads_dir=${nanopore_dir}/B-Group2/data/02-G2-Library2-Flongle-kraken2/raw-reads
    export raw_reads_url="https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group2_Flongle/Library2/20250824_1851_MD-101223_AYX067_7881f908/fastq_pass/"
    export trimmed_fastqc_dir=${output_dir_top}/trimmed-fastqc
    export trimmed_reads_dir=${nanopore_dir}/B-Group2/output/02-G2-Library2-Flongle-kraken2/trimmed-reads
...
<https://gannet.fish.washington.edu/kdurkin1/SIFP_2025/Group2_Flongle/Library2/20250824_1851_MD-101223_AYX067_7881f908/fastq_pass/>
...
```
    ...
    total 16K
    drwxr-xr-x 2 shedurkin labmembers 4.0K Sep 30 13:25 barcode18
    drwxr-xr-x 2 shedurkin labmembers 4.0K Sep 30 13:25 barcode19
    drwxr-xr-x 2 shedurkin labmembers 4.0K Sep 30 13:25 barcode20
    drwxr-xr-x 2 shedurkin labmembers 4.0K Sep 30 13:25 unclassified
...
# ---- USER SETTINGS ----
input_dir <- "../output/02-G2-Library2-Flongle-kraken2/kraken2"   # change this
...
![](02-G2-Library2-Flongle-kraken2_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](02-G2-Library2-Flongle-kraken2_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->
