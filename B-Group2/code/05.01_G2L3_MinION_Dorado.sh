#!/bin/bash
## Job Name
#SBATCH --job-name=G2L3_MinION_Dorado
...
#SBATCH --chdir=/gscratch/srlab/kdurkin1/SIFP-nanopore/B-Group2/output/05.01-G2-Library3-MinION-Dorado-recall-GPU/
...
raw_pod5_dir=/gscratch/srlab/kdurkin1/SIFP-nanopore/B-Group2/data/05.01-G2-Library3-MinION-Dorado-recall-GPU/
output_dir=/gscratch/srlab/kdurkin1/SIFP-nanopore/B-Group2/output/05.01-G2-Library3-MinION-Dorado-recall-GPU/
...
--device ${GPU_devices} \
> ${output_dir}/FBD42232_pass_recalled.bam
